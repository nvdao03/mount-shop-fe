export const AUTH_MESSAGE = {
  ...
  PASSWORD_INVALID_MIN_LENGTH: 'Mật khâu phải có ít nhẩt 6',
  ...
  FULLNAME_INVALID_MIN_LENGTH: 'Họ và tên phải có ít nhất 10 ký tự',
  FULLNAME_INVALID_LENGTH: 'Họ và tên phải có ít nhất 2 - 160 ký tự',
