    ...
    <div className='min-h-screen flex'>
          ...
          <div className='hidden lg:flex w-1/2 relative'>
            ...
            <div className='absolute inset-0  flex items-center justify-center'>
              <div className='flex flex-col justify-between text-white p-6 w-[85%] h-[85%] bg-black bg-opacity-40 border-[10px] border-solid'>
                ...
                <p className='font-bold text-[40px] leading-[1.3]'>Đăng ký ngay để trở thành một phần của chúng tôi </p>
              </div>
            </div>
          </div>
          <div className='hidden lg:flex w-1/2 items-center justify-center bg-white'>
            <div className='w-full max-w-md p-8'>
              <div className='text-center'>
                <h2 className='text-2xl font-bold text-center text-primary'>Đăng ký tài khoản mới</h2>
              </div>
              ...
              <div className='flex items-center gap-3 justify-center text-center text-sm mt-5'>
                <span className='block relative'>Đã có tài khoản </span>
                ...
                <Link to={PATH.LOGIN} className='text-primary font-semibold hover:underline'>
                  Đăng nhập
                </Link>
              </div>
            </div>
      ...
      {!isDesktop && (
        <div className='relative w-full lg:hidden'>
          <img src={BackgroundRegister} alt='Shopping' className='w-full h-screen object-cover' />
