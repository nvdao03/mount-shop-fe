...
export default function HomeFlashSale() {
  ...
  const renderButton = () => (
    <>
      <button className='absolute hidden lg:flex button-prev z-10 bg-white items-center justify-center rounded-full w-[40px] left-0 top-[calc(50%-50px)] translate-x-[0] -translate-y-[calc(50%-30px)] sm:-translate-y-[calc(50%-40px)] h-[40px]'>
      ...
      <button className='absolute hidden lg:flex z-10 button-next bg-white items-center justify-center rounded-full w-[40px] right-0 top-[calc(50%-50px)] translate-x-[0] -translate-y-[calc(50%-30px)] sm:-translate-y-[calc(50%-40px)] h-[40px]'>
        <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none'>
          <path
  ...
  return (
    <section className='bg-[#D5D2F9] py-5 md:py-10'>
